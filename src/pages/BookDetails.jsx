      ...
      <div className="w-full lg:w-1/2">
        ...
        <div className="mt-5 space-y-3">
          ...
          <h3 className="text-base text-[#131313B2] font-normal flex gap-44">
            Rating:
            <span className="text-[#131313] font-semibold">{book.rating}</span>
          </h3>
        </div>

        {/* Button for Add Read or Wishlist Book */}
        <div className="flex gap-5 mt-8">
          <button className="border border-[#1313134D] py-3 px-7 rounded-lg text-lg bg-transparent  text-[#131313] font-bold hover:text-[#fff] hover:border-[#50B1C9] hover:bg-[#50B1C9]  transition duration-700">
            Read
          </button>

          <button className="py-3 px-7 rounded-lg text-lg text-[#fff] border border-[#50B1C9] bg-[#50B1C9] font-bold hover:text-[#131313] hover:border-[#1313134D] hover:bg-transparent transition duration-700">
            Wishlist
          </button>
        </div>
      </div>
